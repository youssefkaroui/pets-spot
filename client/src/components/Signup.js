...
const SignUpForm = () => {
  ...
  const [userFormData, setUserFormData] = useState({
    ...
    email: "",
    password: "",
    address: { line_one: "", line_two: "", city: "", state: "", zipcode: "" },
  });
    ...
    <>
      <FormControl
        onClose={() => {
          toast({
            title: "Welcome Back!",
            description:
              "Check out our Listings page for all the animals looking for a new home!",
            status: "success",
            duration: 5000,
            isClosable: true,
          });
      ...
      <FormControl
        onChange={(e) => {
          ...
          setUserFormData({
            ...userFormData,
            address: { ...userFormData.address, [name]: value },
          });
        }}
        mt={4}
      >
